...
export const fr: Translation = {
  app: {
    ...
    usernameMandatory: "votre nom d'utilisateur doit comporter de 3 à 10 caractères alphabétiques",
    passwordMandatory: 'votre mot de passe doit comporter de 5 à 10 caractères alphanumériques',
